...
static class RolePolicies
{
    ...
    public static readonly string RestaurantOwner = DefaultRestaurantUserRoles.Owner.ToString();
    public static readonly string RestaurantCustomer = DefaultRestaurantUserRoles.Customer.ToString();
    public static readonly string RestaurantAdmin = DefaultRestaurantUserRoles.Admin.ToString();
