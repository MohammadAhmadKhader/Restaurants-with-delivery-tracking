...
public interface IAuthService
{
    ...
    Task<(User user, TokenResponse tokenData)> RegisterRestaurant(RegisterDto dto, Guid restaurantId);
    Task<(User user, TokenResponse tokenData)> Login(LoginDto dto);
    Task<(User user, TokenResponse tokenData)> LoginRestaurant(LoginDto dto);
