...
/// <summary>
/// This is used to construct validation messages for 
/// testing purposes and custom validation messages for some scenarios.
/// </summary>
public static class ValidationMessagesBuilder
{
    ...
    public static string FileExtension(params string[] allowedExtensions) =>
        string.Format(ValidationMessageTemplates.FILE_EXTENSION_VALIDATOR,
            string.Join(", ", allowedExtensions.Select(f => f)));

    public static string FileNotEmpty() => ValidationMessageTemplates.FILE_NOT_EMPTY_VALIDATOR;

    public static string FileSize(long comparisonValue) =>
        string.Format(ValidationMessageTemplates.FILE_SIZE_VALIDATOR, comparisonValue);

    public static string PhoneNumber() => ValidationMessageTemplates.PHONE_NUMBER_VALIDATOR;

    public static string IdsListDistinct(string propertyName = "items") =>
            ValidationMessageTemplates.IDS_LIST_DISTINCT_VALIDATOR
            .Replace("{PropertyName}", propertyName);
}